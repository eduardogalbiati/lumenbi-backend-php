...
class CurvaAbcComprasFornecedoresHeadDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.abcComprasFornecedoresHead");
    }
    ...
    public function insert(array $compras)
    {
        ...
        foreach ($compras as $line) {
            $this->insertTableArray('Auper.dbo.abcComprasFornecedoresHead', $line);
        }
  ...
  FROM [Auper].[dbo].[AbcComprasFornecedoresHead]
