...
class CurvaAbcVendasProdutosHeadDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.abcVendasProdutosHead");
    }
    ...
    public function insert(array $vendas)
    {
        ...
        foreach ($vendas as $line) {
            $this->insertTableArray('Auper.dbo.abcVendasProdutosHead', $line);
        }
  ...
  FROM [Auper].[dbo].[AbcVendasProdutosHead]
