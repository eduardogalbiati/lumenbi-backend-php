...
class CurvaAbcComprasProdutosDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.abcComprasProdutos");
    }
    ...
    public function insert(array $vendas)
    {
        ...
        foreach ($vendas as $line) {
            $this->insertTableArray('Auper.dbo.abcComprasProdutos', $line);
        }
  ...
  FROM [Auper].[dbo].[AbcComprasProdutos] VC INNER JOIN [Auper].[dbo].[produtos] P ON P.idProduto = VC.idProduto 
...
FROM [Auper].[dbo].[AbcComprasprodutos] VC INNER JOIN [Auper].[dbo].[produtos] C ON C.idProduto = VC.idProduto 
          Where 
