...
class CurvaAbcVendasClientesHeadDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.abcVendasClientesHead");
    }
    ...
    public function insert(array $vendas)
    {
        ...
        foreach ($vendas as $line) {
            $this->insertTableArray('Auper.dbo.abcVendasClientesHead', $line);
        }
  ...
  FROM [Auper].[dbo].[AbcVendasClientesHead]
