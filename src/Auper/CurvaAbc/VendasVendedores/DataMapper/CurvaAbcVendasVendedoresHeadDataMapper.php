...
class CurvaAbcVendasVendedoresHeadDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.AbcVendasVendedoresHead");
    }
    ...
    public function insert(array $vendas)
    {
        ...
        foreach ($vendas as $line) {
            $this->insertTableArray('Auper.dbo.AbcVendasVendedoresHead', $line);
        }
  ...
  FROM [Auper].[dbo].[AbcVendasVendedoresHead]
