...
class VendasQtdValoresProdutosDataMapper extends AbstractDataMapper
{
    protected $db;
    ...
    {
        $this->dropTable("Auper.dbo.vendasQtdValoresProdutos");
        foreach ($vendas as $line) {
            $this->insertTableArray('Auper.dbo.vendasQtdValoresProdutos', $line);
        }
