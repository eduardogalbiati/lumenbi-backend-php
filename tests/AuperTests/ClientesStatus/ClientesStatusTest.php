...
class ClientesStatusTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testPreparingArrayIntervaloTresRepeticaoTres()
    {
      ...
      //  var_dump($clientes);die;
        ...
        $this->assertEquals($clientes['1']['nomeCliente'] , 'Cliente de Teste');
        $this->assertEquals($clientes['1']['idCliente'] , '1');
