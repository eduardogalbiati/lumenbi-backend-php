...
class FornecedoresStatusTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testPreparingArrayIntervaloTresRepeticaoTres()
    {
        ...
        $clientes[] = array(
            ...
            'mes' => '8',
            'idFornecedor' => '1',
            'nomeFornecedor' => 'Cliente de Teste',
            'qtdTotal' => '1',
            'valorTotal' => '2',
      ...
      //  var_dump($clientes);die;
        ...
        $this->assertEquals($clientes['1']['nomeFornecedor'] , 'Cliente de Teste');
        $this->assertEquals($clientes['1']['idFornecedor'] , '1');
